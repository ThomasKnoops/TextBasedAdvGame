...
namespace ClassLibrary1
{
    internal class LightSource : Item, iLightable
    {
        ...
        public void Light(World w)
        {
            ...
            Console.WriteLine("Finally! I can see in this room. It looks like this is the attic. I see some old boxes against the wall with lots of dust on them. Oh! What is that, a lockpick?");
            return;
        }
